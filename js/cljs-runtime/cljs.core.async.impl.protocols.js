...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26884 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26884(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26890 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26890(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26895 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26895(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26896 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26896(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26901 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26901(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26905 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26905(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26912 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26912(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26916 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26916(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26918 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26918(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26922 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26922(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26930 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26930(b);
}
});
