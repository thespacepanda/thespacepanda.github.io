...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25917 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25917(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25921 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25921(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25924 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25924(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25925 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25925(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25928 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25928(reader);
}
});
...
var G__25962 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
