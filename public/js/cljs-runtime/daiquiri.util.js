...
var vec__25880 = cljs.core.name(k).split("-");
var seq__25881 = cljs.core.seq(vec__25880);
var first__25882 = cljs.core.first(seq__25881);
var seq__25881__$1 = cljs.core.next(seq__25881);
var first_word = first__25882;
var words = seq__25881__$1;
...
var m__$1 = cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (p1__25883_SHARP_,p2__25884_SHARP_,p3__25885_SHARP_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(p1__25883_SHARP_,daiquiri.util.camel_case(p2__25884_SHARP_),p3__25885_SHARP_);
}),cljs.core.transient$(cljs.core.PersistentArrayMap.EMPTY),m));
var G__25886 = m__$1;
if(cljs.core.map_QMARK_(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m__$1))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__25886,new cljs.core.Keyword(null,"style","style",-496642736),daiquiri.util.camel_case_keys);
} else {
return G__25886;
}
} else {
